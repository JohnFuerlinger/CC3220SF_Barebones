...
#ifndef LIBRARY_LAYER_JUPRINTF_H_
#define LIBRARY_LAYER_JUPRINTF_H_

#include <hardware_layer/uart.h>
#include "stdarg.h"
#include "string.h"

#define     BYTEOUT_L(x)    BYTEOUT_D(x)

void juprintf(const char * msg, ...);



#endif /* LIBRARY_LAYER_JUPRINTF_H_ */
